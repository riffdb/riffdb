...
| [0208](0208-exact-empty-command-authority-avoids-command-audit-index-activation.md) | Exact-Empty Command Authority Avoids Command-Audit Index Activation | Proposed | guarantee |
<!-- adr-index:end -->
