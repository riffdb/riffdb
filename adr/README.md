...
| [0005](0005-idempotency-identity-terminal-outcomes-and-sequences.md) | Idempotency Identity, Terminal Outcomes, and Sequence Semantics | Proposed |
...
| [0011](0011-canonical-values-keys-and-hashing.md) | Canonical Values, Fixed-Scale Decimals, Keys, and Hashing | Proposed |
| [0012](0012-deterministic-transaction-context.md) | Deterministic Transaction Context | Proposed |

The human architecture review on 2026-07-12 approved the direction represented
by ADR-0001 through ADR-0012. Every record remains Proposed until its exact text
