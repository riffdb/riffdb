...
- **Administrative package renumbering:** WP-625 through WP-627 to WP-628
  through WP-630 — 2026-08-15 (maintainer, in session); no semantic change
- **Decision deadline:** Before WP-628 changes contract grammar, executable IR,
...
- **Defines or blocks:** WP-628 through WP-630
...
- **Defines or blocks:** WP-628 (syntax, V13 IR, compiler proof, diagnostics and
  fixtures), WP-629 (runtime, storage, concurrency, recovery and replication),
  and WP-630 (Better Auth command, all-language and real package-arrival
  lifecycle).
- **Final evidence:** WP-630 and the final alpha qualification.
