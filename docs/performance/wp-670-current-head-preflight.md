...
on each inventoried cloud profile. N1 (`34.138.100.108`) and E2
(`35.231.16.106`) ran in parallel; each host ran safe-application PostgreSQL
and RiffDB sequentially. All databases and build artifacts lived under
`/home/kevin/tmp` on persistent VM storage.
...
- `/home/kevin/tmp/wp670-c1-{pg,rd}-{n1,e2}.json`
- `/home/kevin/tmp/wp670-c32-{pg,rd}-{n1,e2}.json`
- `/home/kevin/tmp/wp670-transport-{n1,e2}.json`
