...
export const QUERY_MODULE_HASH = "4d91b038b0f72770ececae8f3f7c6bc13bf8162abf6532fede49f762b712868d" as const;
export const CONTRACT_LINEAGE = "DriverConformance" as const;
export const CONTRACT_VERSION = 1 as const;
export const CONTRACT_BUNDLE_HASH = "d7c86778e9adc0cbbf7c7a0b9a40e523da30cc4c6b0ab53b24d1ed4d6b7e8da8" as const;
...
export const ITEM_PAGE_QUERY_PLAN_HASH = "9d0521d5cdbb526bf170d6933d03265840e6397661640a064a3eb660b3310e4b" as const;
...
export const ITEM_SECRET_QUERY_PLAN_HASH = "e623a69842d8a88348ab5449b2de4b4793a7cd814f0d82d090a0b1171ff19d5e" as const;
...
export function itemSecret(parameters: ItemSecretParams): NamedQueryRequest<ItemSecretParams, ItemSecretResult> {
  return { driverOperation: { name: "driver_conformance_item_secret", inputSchemaHash: "e80f7b5c93c2a56b94d286b35377068aea67449dcb2a8f243a00375ffe92e47b" }, contractLineage: CONTRACT_LINEAGE, contractVersion: CONTRACT_VERSION, contractBundleHash: CONTRACT_BUNDLE_HASH, moduleHash: QUERY_MODULE_HASH, queryName: "ItemSecret", planHash: ITEM_SECRET_QUERY_PLAN_HASH, parameters, parameterSchema: {"fields":[{"name":"item_id","schema":{"kind":"uuid"}}],"kind":"record"}, resultSchemas: {"Found":{"fields":[{"name":"secret","schema":{"fields":[{"name":"token_digest","schema":{"kind":"string"}}],"kind":"record"}}],"kind":"record"},"NotFound":{"fields":[],"kind":"record"}}, decodeError: decodeApplicationError };
}
...
export const CREATE_ITEM_PLAN_HASH = "3f8a3041bd21b64bfce8bd8e6df3ab755e056e2f0753e6c49117e15fa06f3d8c" as const;
export function createItem(input: CreateItemInput): CommandRequest<CreateItemInput, CreateItemOutcome> {
  return { driverOperation: { name: "driver_conformance_create_item", inputSchemaHash: "eafc5a6d2e5fecc1c61d661338ee56d5a81638d25c820108e50e688de19a8fea" }, contractLineage: CONTRACT_LINEAGE, contractVersion: CONTRACT_VERSION, commandName: "CreateItem", planHash: CREATE_ITEM_PLAN_HASH, input, idempotencyKey: input.idempotency_key, inputSchema: {"fields":[{"name":"title","schema":{"kind":"string"}},{"name":"item_id","schema":{"kind":"uuid"}},{"name":"token_digest","schema":{"kind":"string"}},{"name":"idempotency_key","schema":{"kind":"string"}}],"kind":"record"}, outcomeSchemas: {"Created":{"fields":[],"kind":"record"},"ItemExists":{"fields":[{"name":"item_id","schema":{"kind":"uuid"},"wireId":1}],"kind":"record"}}, decodeError: decodeApplicationError };
}
