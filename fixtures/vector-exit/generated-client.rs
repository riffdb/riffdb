...
pub const QUERY_MODULE_HASH: [u8; 32] = [0x97, 0x85, 0x17, 0x2b, 0xbe, 0xce, 0xfb, 0xf9, 0xfb, 0x40, 0x19, 0x0d, 0x66, 0xb8, 0x92, 0x12, 0xa7, 0x17, 0x78, 0x42, 0xf7, 0x17, 0x03, 0x3e, 0xe9, 0x32, 0x95, 0x30, 0xfb, 0xcf, 0xf3, 0xf9];
...
pub const SIMILAR_DOCUMENTS_QUERY_PLAN_HASH: [u8; 32] = [0xcd, 0xfa, 0x2d, 0x63, 0x68, 0xc5, 0x47, 0xcb, 0x53, 0x2d, 0xf0, 0x56, 0xfe, 0x16, 0x34, 0x45, 0xe2, 0x62, 0xf4, 0x50, 0x77, 0x61, 0x6a, 0xa1, 0x22, 0x37, 0x64, 0xa8, 0x16, 0x03, 0x5e, 0x24];
#[derive(Clone, Debug, Eq, PartialEq)]
...
impl GeneratedQuery for SimilarDocumentsQuery {
    ...
    fn named_query(self, options: QueryOptions) -> Result<NamedQuery, ApplicationClientError> {
        ...
        if self.0.k == 0 || self.0.k > 499 { return Err(ApplicationClientError::InvalidInput); }
