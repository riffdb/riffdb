...
export class TicketDeskReactiveClient {
  ...
  public ticketEvents(parameters: TicketEventsParams, consumerName: string, options: ReactiveConsumerOptions = {}): AsyncIterable<ReactiveConsumerBatch<TicketEventsEvent>> { return this.transport.consumeEventStream({ reactiveModuleHash: TICKET_ACTIVITY_REACTIVE_MODULE_HASH, operationName: "TicketEvents", parameters, parameterSchema: TicketEventsParameterSchema, consumerName }, options); }
  public ackTicketEvents(parameters: TicketEventsParams, consumerName: string, delivery: TicketEventsDelivery): Promise<ReactiveEventMutationResult> { return this.transport.acknowledgeEvent({ reactiveModuleHash: TICKET_ACTIVITY_REACTIVE_MODULE_HASH, operationName: "TicketEvents", parameters, parameterSchema: TicketEventsParameterSchema, consumerName }, delivery); }
  ...
  public seekTicketEvents(parameters: TicketEventsParams, consumerName: string, checkpoint = "before-first"): Promise<ReactiveEventMutationResult> { return this.transport.seekEventConsumer({ reactiveModuleHash: TICKET_ACTIVITY_REACTIVE_MODULE_HASH, operationName: "TicketEvents", parameters, parameterSchema: TicketEventsParameterSchema, consumerName }, checkpoint); }
  public ticketEventsStatus(parameters: TicketEventsParams, consumerName: string): Promise<ReactiveConsumerStatus | undefined> { return this.transport.eventConsumerStatus({ reactiveModuleHash: TICKET_ACTIVITY_REACTIVE_MODULE_HASH, operationName: "TicketEvents", parameters, parameterSchema: TicketEventsParameterSchema, consumerName }); }
  public watchTicketPageWatch(parameters: TicketPageWatchParams, cursor?: string): AsyncIterable<TicketPageWatchUpdate> { return this.transport.watchNamedQuery({ reactiveModuleHash: TICKET_ACTIVITY_REACTIVE_MODULE_HASH, operationName: "TicketPageWatch", parameters, parameterSchema: TicketPageWatchParameterSchema, ...(cursor === undefined ? {} : { cursor }) }); }
  public watchTicketQueueWatch(parameters: TicketQueueWatchParams, cursor?: string): AsyncIterable<TicketQueueWatchUpdate> { return this.transport.watchNamedQuery({ reactiveModuleHash: TICKET_ACTIVITY_REACTIVE_MODULE_HASH, operationName: "TicketQueueWatch", parameters, parameterSchema: TicketQueueWatchParameterSchema, ...(cursor === undefined ? {} : { cursor }) }); }
  public nextTriageTicket(parameters: TriageTicketParams, consumerName: string, maximumWaitMs = 30000): Promise<TriageTicketBatch> { return this.transport.consumeContextualSubscription({ reactiveModuleHash: TICKET_ACTIVITY_REACTIVE_MODULE_HASH, operationName: "TriageTicket", parameters, parameterSchema: TriageTicketParameterSchema, consumerName }, maximumWaitMs); }
  public ackTriageTicket(parameters: TriageTicketParams, consumerName: string, item: TriageTicketItem): Promise<ReactiveEventMutationResult> { return this.transport.acknowledgeContextualItem({ reactiveModuleHash: TICKET_ACTIVITY_REACTIVE_MODULE_HASH, operationName: "TriageTicket", parameters, parameterSchema: TriageTicketParameterSchema, consumerName }, item); }
  public nackTriageTicket(parameters: TriageTicketParams, consumerName: string, item: TriageTicketItem, retryDelayMs = 0): Promise<ReactiveEventMutationResult> { return this.transport.negativeAcknowledgeContextualItem({ reactiveModuleHash: TICKET_ACTIVITY_REACTIVE_MODULE_HASH, operationName: "TriageTicket", parameters, parameterSchema: TriageTicketParameterSchema, consumerName }, item, retryDelayMs); }
