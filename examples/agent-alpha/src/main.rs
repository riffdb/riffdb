...
use generated::{
    CreateItemInput, ItemPageParams, ItemPageResult, AgentAlphaClient,
};
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let mut application = AgentAlphaClient::new(
        client,
    ...
    application
        .create_item(CreateItemInput {
            idempotency_key: "agent-alpha-generated-client-item".to_owned(),
