...
export const QUERY_MODULE_HASH = "af7f316551add4b4c12025387b206e384406821b5d327c378f4fa93838ebac97" as const;
...
export const BOARD_PAGE_QUERY_PLAN_HASH = "23101f02a3fb909062807b49d8932c7e6234be7cfe8055471098d4984ae0903e" as const;
...
export interface BoardPageFound {
...
export class TicketDeskClient {
  ...
  public async boardPage(parameters: BoardPageParams, options: QueryOptions = {}): Promise<TypedQueryResult<BoardPageResult>> {
    const request = boardPage(parameters);
    const result = await this.transport.executeNamedQuery<BoardPageParams, BoardPageResult>(request, options);
