...
export const QUERY_MODULE_HASH = "a286d52b4ac4a6433bd5038ddaf2cbca12228564eccf5c9cdbbeb5e356249863" as const;
export const CONTRACT_LINEAGE = "TicketDesk" as const;
export const CONTRACT_VERSION = 1 as const;
export const CONTRACT_BUNDLE_HASH = "4137b07572c6efc3423411e782ca5424fb66eaf1baee117dc340c5d978e92986" as const;
...
export const BOARD_PAGE200_QUERY_PLAN_HASH = "0a1ae618490625e0847b4eb7ef01587da13dbbcc29bba077cd12954211b5dbf3" as const;
...
export const BOARD_PAGE50_QUERY_PLAN_HASH = "5688ca0c7fc293fbe56145376105a79f70873b34f847f5750ab8ce36ed9ab292" as const;
...
export const BOARD_PAGE500_QUERY_PLAN_HASH = "9adfa7b2fe1406dffa99418ccb400e9539a9dfc6d7b6602a5f8ebcc0ecb273bb" as const;
export interface BoardPage500Params {
  readonly organization_id: string;
  readonly project_id: string;
  readonly status: string;
}

export interface BoardPage500Found {
  readonly outcome: "Found";
  readonly tickets: ReadonlyArray<{ readonly ticket_id: string; readonly project_id: string; readonly title: string; readonly status: string; readonly reporter_id: string; readonly assignee_id: string }>;
}

export type BoardPage500Result = BoardPage500Found;

export function boardPage500(parameters: BoardPage500Params): NamedQueryRequest<BoardPage500Params, BoardPage500Result> {
  return { contractLineage: CONTRACT_LINEAGE, contractVersion: CONTRACT_VERSION, contractBundleHash: CONTRACT_BUNDLE_HASH, moduleHash: QUERY_MODULE_HASH, queryName: "BoardPage500", planHash: BOARD_PAGE500_QUERY_PLAN_HASH, parameters, parameterSchema: {"fields":[{"name":"organization_id","schema":{"kind":"uuid"}},{"name":"project_id","schema":{"kind":"uuid"}},{"name":"status","schema":{"kind":"enum"}}],"kind":"record"}, resultSchemas: {"Found":{"fields":[{"name":"tickets","schema":{"kind":"list","maximum":500,"value":{"fields":[{"name":"ticket_id","schema":{"kind":"uuid"}},{"name":"project_id","schema":{"kind":"uuid"}},{"name":"title","schema":{"kind":"string"}},{"name":"status","schema":{"kind":"enum"}},{"name":"reporter_id","schema":{"kind":"uuid"}},{"name":"assignee_id","schema":{"kind":"uuid"}}],"kind":"record"}}}],"kind":"record"}}, decodeError: decodeApplicationError };
}

export const GET_TICKET_QUERY_PLAN_HASH = "1fb6b4cbb4a7810457d07826d0cbbab74354cc82e04e5d056af7985761e0028c" as const;
...
export const GET_USER_QUERY_PLAN_HASH = "df8f1ce103d2b0271fd788b82042ff5916938701c8ea086b60573516dddd6e43" as const;
...
export const LIST_COMMENTS_QUERY_PLAN_HASH = "96ac40882f95ad06a46cf9a363870a50a2430776277c079223bd090ee596d109" as const;
...
export const LIST_TICKETS_QUERY_PLAN_HASH = "9cdba9d45af89abcc5b697b40dccccb231f65bd0b42f85a4466ce7b643c2793b" as const;
...
export const LIST_TICKETS_BY_ASSIGNEE_QUERY_PLAN_HASH = "9421f819180b7e14948853dc58e4432ad1224cca9dceabb7a0c34a3775eb0ec4" as const;
...
export const PROJECT_MEMBERS_QUERY_PLAN_HASH = "f753daf428c686ace0962163f78d4e5fa72567912ad631799926c85a1221d113" as const;
...
export const PROJECT_SUMMARY_QUERY_PLAN_HASH = "7aaf205c085348d339b22021f964f54062020855709719ab6a57586a25d0af02" as const;
...
export const TICKET_PAGE_QUERY_PLAN_HASH = "f13b9c5637e3e44f12d45750ea681523ccc19a6eb208d483f53c9f84fe42d4c0" as const;
...
export const CREATE_TICKET_PLAN_HASH = "fa9cc24dd158569bc5b83b0287bbf1db72dc3be8f0f0f1b680d7b8ccb8c886fc" as const;
...
export class TicketDeskClient {
  ...
  public async boardPage500(parameters: BoardPage500Params, options: QueryOptions = {}): Promise<TypedQueryResult<BoardPage500Result>> {
    const request = boardPage500(parameters);
    const result = await this.transport.executeNamedQuery<BoardPage500Params, BoardPage500Result>(request, options);
    if (!acceptsIdentity(request, result.identity)) throw new Error("RiffDB application identity mismatch");
    return result;
  }
