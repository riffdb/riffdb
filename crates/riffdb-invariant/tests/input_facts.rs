...
use riffdb_contract_ir::{
    ...
    CommandInputSchema, CommandPlan, ConflictDerivationPlan, ExecutionClass, ExprId,
    ExpressionArena, ExpressionKind, FieldSchema, Instruction, KeyComponentSchema, KeyPurpose,
    KeySchema, LocalityPlan, OutcomeConstruction, OutcomeSchema, RecordSchema, RecordTypeRef,
    SchemaIr, ValueType,
};
...
use riffdb_types::{
    ...
    EntityTypeId, FieldId, OutcomeId,
};
