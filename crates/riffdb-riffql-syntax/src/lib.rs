...
pub use syntax::{
    ...
    ExistencePredicate, ExpansionDriver, Expression, FieldSelection, Identifier, Literal,
    MAX_BOUNDED_SET_ITEMS_V1, MAX_PROJECTED_CAUSAL_WAIT_MS, MAX_PROJECTED_LAG_MS, NearestClause,
    NullPlacement, OrderFamily, OrderFamilyVariant, OrderTerm, Parameter, Path, ProjectedFreshness,
    ProjectedSource, QueryBody, RIFFQL_LANGUAGE_VERSION, RIFFQL_LANGUAGE_VERSION_BOUNDED_LIMIT_V1,
