...
fn offline_maintenance_surface_is_exact_and_additive() {
    ...
    for (name, expected) in [
        ...
        (
            "riffdb.v1.ArchiveRestoreObservation",
            vec![
                ("archive_name", 1),
                ("stop_at_sequence", 2),
                ("backup_frontier", 3),
        ...
        ("riffdb.v1.ArchiveBackupFrontier", vec![("application", 1)]),
        (
...
fn service_inventory_and_completed_phase_zero_messages_are_exact() {
    ...
    let completed = [
        ...
        "RestoreArchivedBackupResponse",
        "ArchiveRestoreObservation",
        ...
        "CheckContractMigrationResponse",
