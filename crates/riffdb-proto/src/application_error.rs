...
const fn proto_code(value: DomainCode) -> app_v1::ApplicationErrorCode {
    match value {
        ...
        DomainCode::FollowerMode => app_v1::ApplicationErrorCode::FollowerMode,
        DomainCode::PrimaryFenced => app_v1::ApplicationErrorCode::PrimaryFenced,
...
fn domain_code(value: i32) -> Result<DomainCode, ApplicationErrorWireError> {
    ...
    match Wire::try_from(value) {
        ...
        Ok(Wire::FollowerMode) => Ok(DomainCode::FollowerMode),
        Ok(Wire::PrimaryFenced) => Ok(DomainCode::PrimaryFenced),
