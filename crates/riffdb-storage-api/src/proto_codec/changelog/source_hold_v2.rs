...
pub fn encode_replication_source_hold_v2(
    ...
    encode_message(RECORD, &to_wire(value))
}

pub(super) fn to_wire(value: ReplicationSourceHoldV2) -> wire::StoredReplicationSourceHoldV2 {
...
pub fn decode_replication_source_hold_v2(
    ...
    decode_message::<wire::StoredReplicationSourceHoldV2, _, _>(RECORD, encoded, from_wire)
}

pub(super) fn from_wire(
    v: wire::StoredReplicationSourceHoldV2,
) -> Result<ReplicationSourceHoldV2, DurableCodecError> {
    ...
    ReplicationSourceHoldV2::new(
        ...
        FollowerHoldBudget::new(v.hold_budget_sequences).ok_or_else(DurableCodecError::corrupt)?,
        expiry,
        phase,
