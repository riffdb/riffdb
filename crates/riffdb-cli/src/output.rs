...
impl CommandIdentity {
    pub(crate) const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::CommandBatch => "command.batch",
            Self::CommandOutcome => "command.outcome",
            Self::EntityGet => "entity.get",
            Self::CommitShow => "commit.show",
            Self::EventDescribe => "event.describe",
            Self::EventReplay => "event.replay",
            Self::EventTail => "event.tail",
            Self::EventConsume => "event.consume",
            Self::EventAck => "event.ack",
            Self::EventNack => "event.nack",
            Self::EventSeek => "event.seek",
            Self::EventRetire => "event.retire",
            Self::EventStatus => "event.status",
            Self::ContextualNext => "contextual.next",
            Self::ContextualAck => "contextual.ack",
            Self::ContextualNack => "contextual.nack",
            Self::ContextualStatus => "contextual.status",
            Self::ContextualReact => "contextual.react",
            ...
            Self::QueryProjected => "query.projected",
            Self::QueryWatch => "query.watch",
            Self::QueryDeploy => "query.deploy",
            Self::QueryModule => "query.module",
            Self::QueryRepl => "query.repl",
            Self::QueryInspectVector => "query.inspect_vector",
            ...
            Self::FollowerRegister => "follower.register",
            Self::FollowerRetire => "follower.retire",
            Self::FollowerFencePrimary => "follower.fence-primary",
            Self::FollowerPromote => "follower.promote",
            ...
            Self::ExportStatus => "export.status",
            Self::ExportCancel => "export.cancel",
            Self::ReimportStart => "reimport.start",
