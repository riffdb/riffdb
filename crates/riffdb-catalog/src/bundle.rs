...
use riffdb_contract_ir::{
    ...
    BUNDLE_FORMAT_VERSION_V22, CommandPlan, ContractBundle, EXECUTABLE_IR_VERSION_V1,
    ...
    GRAMMAR_VERSION_V21, GRAMMAR_VERSION_V22, MCP_COMMAND_NAME_REGISTRY_VERSION_V2,
